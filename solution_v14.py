...
def build_features_for_candidates(query, candidate_ids):
    ...
    for aid in candidate_ids:
        ...
        interactions = [
            base[0] * base[3],   # bm25 * bm25_title
            base[6] * base[18],  # tfidf * emb_minilm
            base[18] * base[24], # emb_minilm * emb_rubert
            base[1] * base[19],  # norm_bm25 * norm_emb_minilm
            base[2] * base[20],  # rank_bm25 * rank_emb_minilm
            base[6] * base[7],   # tfidf * tfidf_title
            base[18] * base[21], # emb_minilm * emb_title_minilm
        ]
