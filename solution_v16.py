...
print("Grid search LightGBM params...")

param_options = [
    {"num_leaves": 31, "learning_rate": 0.05, "num_boost_round": 300},
    {"num_leaves": 63, "learning_rate": 0.05, "num_boost_round": 300},
    {"num_leaves": 127, "learning_rate": 0.03, "num_boost_round": 300},
    {"num_leaves": 63, "learning_rate": 0.03, "num_boost_round": 400},
    {"num_leaves": 63, "learning_rate": 0.05, "num_boost_round": 250},
    {"num_leaves": 31, "learning_rate": 0.1, "num_boost_round": 200},
]

best_map = 0
best_params = None

for param_set in param_options:
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(all_queries)):
        ...
        params = {
            ...
            "ndcg_eval_at": [10],
            "boosting_type": "gbdt",
            "num_leaves": param_set["num_leaves"],
        ...
        ranker = lgb.train(params, train_set, num_boost_round=param_set["num_boost_round"])
        ...
        cv_scores.append(np.mean(ap_scores))
    
    mean_map = np.mean(cv_scores)
    print(f"Mean CV MAP@10: {mean_map:.4f} (+/- {np.std(cv_scores):.4f})")
    
    if mean_map > best_map:
        best_map = mean_map
        best_params = param_set

print(f"\nBest MAP@10: {best_map:.4f}")
