...
print("Loading rubert-tiny2 embeddings...")
...
weight_options = []
for emb_w in [1.5, 1.8, 2.0, 2.2, 2.5, 3.0]:
    for title_w in [0.5, 0.8, 1.0, 1.2, 1.5]:
        for tfidf_w in [0.8, 1.0, 1.2, 1.5]:
            for stop_w in [0.5, 0.8, 1.0]:
                weight_options.append([1.0, 1.0, stop_w, tfidf_w, emb_w, title_w])

for k_val in [30, 40, 60, 80]:
